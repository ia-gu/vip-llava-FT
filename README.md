...
```bash
git clone https://github.com/mu-cai/ViP-LLaVA
cd ViP-LLaVA
```
...
```
3. Download contents
- [Model Weights](https://huggingface.co/mucai/vip-llava-7b/tree/main)
- [Jsons](https://huggingface.co/datasets/mucai/ViP-LLaVA-Instruct/tree/main)
